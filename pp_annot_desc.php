...
<div class="colapse_section pointer_cursor" data-toggle="collapse" data-target="#annot_section"><h3>Annotations</h3></div>
...
while ($line = pg_fetch_array($sp_res, null, PGSQL_ASSOC)) {
    ...
    echo "<tr><td><a href=\"$sp_link\" target=\"_blank\">$sp_id</a></td><td>$sp_desc</td><td><a href=\"$sp_link\" target=\"_blank\">SwissProt</a></td></tr>\n";
}
while ($line = pg_fetch_array($at_res, null, PGSQL_ASSOC)) {
    ...
    echo "<tr><td><a href=\"$tair_link\" target=\"_blank\">$tair_id</a></td><td>$tair_desc</td><td><a href=\"$tair_link\" target=\"_blank\">TAIR</a></td></tr>\n";
}
while ($line = pg_fetch_array($nr_res, null, PGSQL_ASSOC)) {
    ...
    echo "<tr><td><a href=\"$nr_link\" target=\"_blank\">$nr_id</a></td><td>$nr_desc</td><td><a href=\"$nr_link\" target=\"_blank\">NCBI</a></td></tr>\n";
}
while ($line = pg_fetch_array($pz_res, null, PGSQL_ASSOC)) {
    ...
    echo "<tr><td><a href=\"$pz_link\" target=\"_blank\">$gene_name_displayed</a></td><td>$pz_desc</td><td><a href=\"$pz_link\" target=\"_blank\">Phytozome</a></td></tr>\n";
}

$plaza_gene = preg_replace('/V3\.1/','',$gene_name_displayed);
echo "<tr><td><a href=\"https://bioinformatics.psb.ugent.be/plaza/genes/redirect_gene/3218/$plaza_gene\" target=\"_blank\">$gene_name_displayed</a></td><td></td><td><a href=\"https://bioinformatics.psb.ugent.be/plaza/genes/redirect_gene/3218/$gene_name_displayed\" target=\"_blank\">PLAZA</a></td></tr>\n";
echo "</table>\n\n";
